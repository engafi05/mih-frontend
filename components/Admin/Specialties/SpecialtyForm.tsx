...
const SpecialtyForm: React.FC<SpecialtyFormProps> = ({ specialty, onSuccess }) => {
    ...
    useEffect(() => {
        if (specialty) {
            setFormData({
                ...
                iconClass: specialty.IconClass || 'fas fa-stethoscope'
            });
        }
    }, [specialty]);
    ...
    return (
        <form onSubmit={handleSubmit} className="space-y-4 text-right" dir="rtl">
            ...
            <div>
                <label className="block text-sm font-bold mb-1">أيقونة التخصص</label>
